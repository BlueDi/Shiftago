...
function MyGraphLeaf(graph, xmlelem) {
    ...
    if (this.type == 'cylinder') {
        this.object = new Cylinder(graph.scene, parseFloat(args[0]), parseFloat(args[1]), parseFloat(args[2]), parseFloat(args[3]), parseFloat(args[4]), parseFloat(args[5]), parseFloat(args[6]));
